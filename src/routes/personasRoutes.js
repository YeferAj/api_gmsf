...
router.get('/:id/beneficiarios', personasController.getBeneficiariosByTitular);
router.post('/:id/membresia', personasController.assignMembresia);
router.get('/:id/membresia', personasController.getPersonaMembresia);
